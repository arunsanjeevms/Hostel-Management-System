                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" required>
                            ...
                            <option>Electronics and Electrical Engineering</option> <!-- your custom dept -->
                        </select>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="tel" class="form-control" placeholder="Enter alternate phone">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="tel" class="form-control" placeholder="Enter parent phone number" required>
                    </div>
                </div>
