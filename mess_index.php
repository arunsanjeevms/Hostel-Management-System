...
<head>
    ...
    <style>
        ...
        .custom-tabs .nav-item:nth-child(1) .nav-link.active {
            background: linear-gradient(135deg, #af4c91ff 0%, #cc4da2ff 100%);
            color: white;
    ...
    <body class="content">
        ...
        <div class="custom-tabs">
            ...
            <div class="statistics-container">
                <!-- Box 1: Special Tokens (Green) -->
                <div class="stat-box">
                    <h3 id="totalSpecialTokens">0</h3>
                    <p>Special Tokens</p>
                </div>

                <!-- Box 2: Menu Items (Blue) -->
                <div class="stat-box">
                    <h3 id="totalMenus">0</h3>
                    <p>Menu Items</p>
                </div>

                <!-- Box 3: Total Tokens (Orange) -->
                <div class="stat-box">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="menu" role="tabpanel">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="btn-group btn-group-sm">
                            ...
                            <h4>
                                <button type="button" class="btn btn-secondary style-hbJUz" data-bs-toggle="modal" data-bs-target="#breakfastModal" id="style-hbJUz"> <i class="fas fa-plus"></i> Breakfast
                                </button>
                            </h4>

                            <h4>
                                <button type="button" class="btn btn-secondary style-hbJUz" data-bs-toggle="modal" data-bs-target="#lunchModal" id="style-hbJUz"> <i class="fas fa-plus"></i> Lunch
                                </button>
                            </h4>
                            ...
                            <h4><button type="button" class="btn btn-secondary style-hbJUz" data-bs-toggle="modal" data-bs-target="#dinnerModal">
                ...
                <div class="tab-pane fade" id="specialtokens" role="tabpanel">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <h3>
                            <button type="button" class="btn btn-secondary style-hbJUz" data-bs-toggle="modal" data-bs-target="#specialtokenModal" id="style-hbJUz"> Enable Special Token </button>
                        </h3>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody id="specialtokenEnableTable">
                                <tr>
                ...
                <div class="tab-pane fade" id="history" role="tabpanel">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="btn-group btn-group-sm">
                            <h4>
                                <button type="button" class="btn btn-secondary style-hbJUz" id="style-hbJUz" onclick="viewHistory('menu')"> Menu History </button>
                            </h4>
                            <h4>
                                <button type="button" class="btn btn-secondary style-hbJUz" id="style-hbJUz" onclick="viewHistory('special')">Special Token History</button>
                            </h4>
                        </div>
                    </div>
                    <div class="table-responsive">
        ...
        <script>
            ...
            function displayMenus() {
                const tableBody = document.querySelector('#messMenuTable');
                tableBody.innerHTML = '';
        ...
        `;
            ...
            function editMenu(menuId) {
                console.log("Editing menu:", menuId);
            ...
            function updateMenu() {
                ...
                $.post('api.php', data, function(response) {
                    ...
                    showMessage('error', 'Failed to update menu');
                });
            }
            ...
            function displaySpecialTokens() {
                const tableBody = document.querySelector('#specialtokenEnableTable');
                tableBody.innerHTML = '';

                if (allSpecialTokens.length === 0) {
                    tableBody.innerHTML = '<tr><td colspan="10" class="text-center">No special tokens found</td></tr>';
                    return;
                }
        ...
        `;
            ...
            function editSpecialToken(specialId) {
                const token = allSpecialTokens.find(t => t.special_id == specialId);
                if (!token) {
                    showMessage('error', 'Special Token not found');
                    return;
                }

                $('#editSpecialMenuId').val(token.special_id);
