...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2025 at 07:40 AM
...
(1, '2034', 'Vedha Boys Hostel', 'Male', '67, hig, karur', '0000-00-00 00:00:00'),
(2, '3024', 'ML Girls Hostel', 'Female', '34, ghn, karur', '0000-00-00 00:00:00'),
(3, '4032', 'Other Hostel', 'Male', '56,hnj,karur', '0000-00-00 00:00:00');
...
CREATE TABLE `rooms` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `status` enum('Available','Under Construction','Not Available') DEFAULT 'Available'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `rooms` (`room_id`, `hostel_id`, `room_number`, `capacity`, `occupied`, `room_type`, `created_at`, `updated_at`, `status`) VALUES
(4, 2, '2', 3, 0, 'Non-AC', '2025-10-07 06:16:25', '2025-10-07 06:16:25', 'Available'),
(5, 1, '3', 3, 0, 'AC', '2025-10-07 06:24:36', '2025-10-07 06:24:36', 'Available'),
(6, 1, '8', 3, 0, 'Non-AC', '2025-10-07 06:29:33', '2025-10-07 06:29:33', 'Available'),
(7, 1, '5', 3, 3, 'Non-AC', '2025-10-07 06:55:02', '2025-10-08 04:57:14', 'Under Construction'),
(8, 1, '89', 3, 2, 'AC', '2025-10-08 03:53:48', '2025-10-08 04:55:31', 'Under Construction'),
(9, 2, '90', 3, 9, 'Non-AC', '2025-10-08 03:54:16', '2025-10-08 03:54:16', 'Available'),
(10, 1, '7', 3, 2, 'AC', '2025-10-08 04:42:28', '2025-10-08 04:57:47', 'Available');
